	...
	return (
		...
		<article className="flex flex-col w-fit  ">
			...
			<div className="flex items-center justify-center w-full mt-4">
				<a download href='/Resume.pdf'  className=" w-40 flex items-center justify-center p-2.5 px-6 border-2 border-solid rounded-md border-primary dark:border-primary-dark bg-primary dark:bg-primary-dark font-semibold hover:bg-primary/90 dark:hover:bg-transparent">My Resume</a>
