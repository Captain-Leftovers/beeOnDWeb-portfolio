...
export default function FollowMe() {
	return (
		<section className="fixed flex items-center justify-center rotate-90 -right-10 top-1/2">
			<div className="relative px-6 py-2 rounded-md bg-accent before:content-[''] before:w-10 before:h-[1px]  before:absolute before:-right-10 before:top-1/2  before:-translate-y-1/2 before:bg-text ">FollowMe</div>
